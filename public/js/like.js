...
var lesLiens = document.querySelectorAll(".js-a-like");
...
function majLike(event) {
   ...
   sur lequel s'est produit l'événement c’est-à-dire la balise <a> */
    ...
    xhr.onload = function () {
        ...
        {
            /* si l'élément sur lequel s'est produit l'événement est le 1er
            ...
            {
                event.target.nextElementSibling.textContent = xhr.response.nb_like
            }
            else
            {
                ...
                {
                    event.target.previousElementSibling.textContent = xhr.response.nb_like
                }
                else
                {
                    ...
                    event.target.textContent = xhr.response.nb_like
                }
            }   
        }
    };
